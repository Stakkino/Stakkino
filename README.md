<div align="center">
  <img src="https://raw.githubusercontent.com/Stakkino/Stakkino/main/stakk.gif" alt="Developer" width="500"/>
</div>
...
- 🤝 **Looking to Collaborate:** Backend / full-stack projects (Django, Next.js)
- 💬 **Ask Me About:** Python, Django, algorithms, mathematical logic applied to code
- 📍 **Location:** Madagascar
...
| **Tools** | Git, GitHub, VS Code, Linux | 🟢 Daily Use |
...
[![Stakkino's github activity graph](https://github-readme-activity-graph.vercel.app/graph?username=Stakkino&theme=react-dark&hide_border=true&bg_color=0D1117&color=F5A623&line=F5A623&point=FF8C00)](https://github.com/ashutosh00710/github-readme-activity-graph)

---

## 🎯 Current Focus

- **Expertise:** Backend development with Django, relational database design (PostgreSQL/MySQL) and UML modeling
- **Development:** Building solid, well-architected backend systems before layering on frontend (Next.js/React)
- **Focus:** Strengthening algorithmic thinking and applying mathematical logic to software design
- **Collaboration:** Open to backend and full-stack projects where clean architecture matters
